...
import AIBot from "../components/aibot.browser.component";
            ...
            <Fade in={!scrolling}>
                <Container>
                        ...
                        <div style={{ marginTop: 100,justifyContent: "space-between", display: "flex" }}>
                            <div className="Card">
                                <h1 className="Title" style={{ color: "white" }}>Gex Token</h1>
                            ...
                            </div>
                            {
                                /**
                            <div className="Card">
                                <h1 className="Title" style={{ color: "white" }}>My ChatBot</h1>
                                <h3 className="Subtitle">(ChatGPT)</h3>
                                <AIBot />
                            </div>
                                 */
                            }
