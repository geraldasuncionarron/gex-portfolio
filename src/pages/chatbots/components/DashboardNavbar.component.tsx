...
function DashboardNavbar() {
  ...
  const mobileSidebarToggle = (e: any) => {
    ...
    node.onclick = function () {
      //this.(parentElement as any).removeChild(this);
      document.documentElement.classList.toggle("nav-open");
    };
  ...
  const getBrandText = () => {
    for (let i = 0; i < DashboardComponents.length; i++) {
      if (location.pathname.indexOf(DashboardComponents[i].layout + DashboardComponents[i].path) !== -1) {
        return DashboardComponents[i].name;
      }
    }
    return "Brand";
  };
      ...
      <Container fluid>
        ...
        <Dropdown as={Nav.Item}>
              <Dropdown.Toggle
                ...
                className="m-0"
              >
                <Icon name="notification" color="black" size="1x" />
                <Badge>5</Badge>
              </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item
        ...
        <Dropdown as={Nav.Item}>
              <Dropdown.Toggle
                ...
                className="m-0"
              >
                <Icon name="user" color="black" size="1x" />
              </Dropdown.Toggle>
